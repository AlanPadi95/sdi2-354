 ...
 */
@WebFilter(dispatcherTypes = { DispatcherType.REQUEST }, urlPatterns = { "/restricted/restrictedUser/*" }, initParams = { @WebInitParam(name = "UserParam", value = "/restricted/restrictedAdmin/userIndex.xhtml") })
