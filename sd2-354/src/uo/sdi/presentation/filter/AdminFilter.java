 ...
 */
@WebFilter(dispatcherTypes = { DispatcherType.REQUEST }, urlPatterns = { "/restricted/restrictedAdmin/*" }, initParams = { @WebInitParam(name = "AdminParam", value = "/restricted/restrictedUser/administratorIndex.xhtml") })
